...
export const projects: PortfolioProject[] = [
  ...
  },
  {
    ...
    image: {
      src: '/projects/supraconscious-avatar-ai/internal-journal.png',
      alt: 'Authenticated Supraconscious journal workspace with a private reflection draft, response preferences, and Guide response',
      width: 1531,
      height: 1324,
    },
    galleryTitle: 'Inside the governed reflection product',
    gallerySummary:
      'The authenticated product carries a reflection from private writing into a grounded Guide response, saved history, an explicit seven-dimension model, and user-controlled privacy and security settings.',
    gallery: [
      {
        src: '/projects/supraconscious-avatar-ai/internal-history.png',
        alt: 'Authenticated Supraconscious history dashboard with a recent reflection, entry count, pattern count, and saved session',
        width: 1531,
        height: 1324,
        label: 'Reflection history',
        caption: 'The private dashboard makes continuity legible without turning reflection into a score: entries, active patterns, the latest Guide response, and saved sessions stay visible together.',
        layout: 'wide',
      },
      {
        src: '/projects/supraconscious-avatar-ai/internal-guide.png',
        alt: 'Authenticated Supraconscious Guide page showing the constant Guide and seven equal reflection dimensions',
        width: 1531,
        height: 1324,
        label: 'Constant Guide',
        caption: 'The Guide stays consistent while the seven dimensions remain equal, explicit, and selectively applied to each reflection instead of becoming hidden personas or a ranked progression.',
        layout: 'wide',
      },
      {
        src: '/projects/supraconscious-avatar-ai/internal-settings.png',
        alt: 'Authenticated Supraconscious privacy and preferences page with data-use disclosure, language, passkeys, tone, intensity, and pattern-memory controls',
        width: 1531,
        height: 1324,
        label: 'Privacy and preferences',
        caption: 'Privacy is a product surface: the account explains processing, supports passkeys, keeps pattern memory opt-in, and exposes the Guide tone and reflection intensity as user-controlled settings.',
        layout: 'wide',
      },
    ],
    story: {
    ...
    gallery: [
      {
        ...
        alt: 'EchoAtlas Explore mode showing the approved Bingham Canyon area, attributed map navigation, provider controls, and the equivalent acquisition-results path',
        width: 1440,
        height: 1586,
      ...
      },
      {
        ...
        alt: 'EchoAtlas Analyze workspace showing public Umbra-derived before and after imagery, 26 candidate records, the approved civilian review boundary, and interpretation warnings',
        width: 1440,
        height: 1000,
