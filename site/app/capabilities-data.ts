...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      approvedEvidence({
        id: 'portfolio:capability:creative-technology:progression-lab-ai', maturity: 'production',
        limitations: ['Public deployment does not establish adoption or commercial performance.'],
        label: 'ProgressionLab',
        detail: 'A deployed harmony workspace connecting structured generation to playback, practical voicings, sharing, MIDI, and PDF export.',
        href: '/work/progression-lab-ai',
        source: 'Case study',
        reference: { kind: 'project', id: 'progression-lab-ai' },
      }),
      approvedEvidence({
