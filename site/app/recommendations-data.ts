...
export type Recommendation = {
  ...
  relationship: string;
  quote: string;
  authorProfileUrl: `https://www.linkedin.com/in/${string}/`;
...
type ReconciledRecommendation = Omit<
  Recommendation,
  'sourceId' | 'sourcePageUrl' | 'sourceObservedAt' | 'sourceVisibility' | 'reviewState' | 'publicApproved' | 'limitations'
>;

function reconciledRecommendation(candidate: ReconciledRecommendation): Recommendation {
...
export const recommendations: Recommendation[] = ([
  {
    ...
    authorProfileUrl: 'https://www.linkedin.com/in/sree-sankara/',
  ...
  },
  {
    ...
    authorProfileUrl: 'https://www.linkedin.com/in/ctrubey/',
  ...
  },
  {
    ...
    authorProfileUrl: 'https://www.linkedin.com/in/jasonconover/',
  ...
  },
  {
    ...
    date: 'July 12, 2017',
    relationship: 'Carl was senior to Shervin but didn’t manage Shervin directly',
    authorProfileUrl: 'https://www.linkedin.com/in/shervin-k-ba106b126/',
  ...
  },
  {
    ...
    authorProfileUrl: 'https://www.linkedin.com/in/thelim3y/',
  ...
  },
  {
    ...
    authorProfileUrl: 'https://www.linkedin.com/in/parallel34/',
  ...
  },
  {
    ...
    name: 'Evan Astrowsky',
    headline: 'Production Analyst',
    date: 'February 15, 2012',
    relationship: 'Evan was Carl’s client',
    authorProfileUrl: 'https://www.linkedin.com/in/evanastrowsky/',
  ...
  },
  {
    ...
    authorProfileUrl: 'https://www.linkedin.com/in/rpeake/',
  ...
  },
  {
    ...
    name: 'Jacob Tell',
    headline: 'Entrepreneur / Producer / Psychonaut / Creative Strategist / Community Builder / Magic Moment Cultivator / Music Lover',
    date: 'June 17, 2011',
    relationship: 'Jacob was Carl’s client',
    authorProfileUrl: 'https://www.linkedin.com/in/jacobtell/',
