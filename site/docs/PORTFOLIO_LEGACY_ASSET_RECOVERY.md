...
- **yU+co:** a 562 × 214 static two-state overview adds system context. It may supplement the GIF after rights and attribution review, but it is not a hero image.
...
5. inspect every output frame for private data, licensed content, and visual quality;
